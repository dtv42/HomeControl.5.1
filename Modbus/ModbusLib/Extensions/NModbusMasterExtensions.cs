// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NModbusMasterExtensions.cs" company="DTV-Online">
...
namespace NModbus.Extensions
{
    ...
    /// </para>
    /// </summary>
    public static class NModbusMasterExtensions
    {
        ...
        public static BitArray ReadOnlyBits(this IModbusMaster master, byte slaveAddress, ushort startAddress, bool swapBytes = false) =>
            master.ReadOnlyBitsAsync(slaveAddress, startAddress, swapBytes).Result;
