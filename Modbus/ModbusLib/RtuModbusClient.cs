// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RtuModbusClient.cs" company="DTV-Online">
...
namespace ModbusLib
{
    ...
    public class RtuModbusClient : IRtuModbusClient
    {
        ...
        /// </summary>
        /// <param name="settings">The RTU client settings</param>
        public RtuModbusClient(IRtuClientSettings settings)
        {
            _factory = new ModbusFactory();
            RtuMaster = settings.RtuMaster;
            RtuSlave = settings.RtuSlave;
        }
        ...
        public bool Connect()
        {
            if (string.IsNullOrEmpty(RtuMaster.SerialPort)) return false;
            if (RtuMaster.Baudrate < 0) return false;
            if (!((RtuMaster.DataBits == 7) || (RtuMaster.DataBits == 8))) return false;
            ...
            try
            {
                ...
                if (_serialport != null)
                {
                    ...
                    if (_serialport.IsOpen)
                    {
                        ...
                        ModbusMaster = _factory.CreateRtuMaster(adapter);
                        ModbusMaster.Transport.SlaveBusyUsesRetryCount = true;
                        ModbusMaster.Transport.Retries = RtuMaster.Retries;
                        ModbusMaster.Transport.WaitToRetryMilliseconds = RtuMaster.WaitToRetryMilliseconds;
                        ModbusMaster.Transport.ReadTimeout = RtuMaster.ReadTimeout;
                        ModbusMaster.Transport.WriteTimeout = RtuMaster.WriteTimeout;
                        return true;
                    }
                    else
                    {
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        public bool[] ReadCoils(ushort startAddress, ushort numberOfPoints)
            => ModbusMaster.ReadCoils(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public async Task<bool[]> ReadCoilsAsync(ushort startAddress, ushort numberOfPoints)
            => await ModbusMaster.ReadCoilsAsync(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public ushort[] ReadHoldingRegisters(ushort startAddress, ushort numberOfPoints)
            => ModbusMaster.ReadHoldingRegisters(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public async Task<ushort[]> ReadHoldingRegistersAsync(ushort startAddress, ushort numberOfPoints)
            => await ModbusMaster.ReadHoldingRegistersAsync(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public ushort[] ReadInputRegisters(ushort startAddress, ushort numberOfPoints)
            => ModbusMaster.ReadInputRegisters(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public async Task<ushort[]> ReadInputRegistersAsync(ushort startAddress, ushort numberOfPoints)
            => await ModbusMaster.ReadInputRegistersAsync(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public bool[] ReadInputs(ushort startAddress, ushort numberOfPoints)
            => ModbusMaster.ReadInputs(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public async Task<bool[]> ReadInputsAsync(ushort startAddress, ushort numberOfPoints)
            => await ModbusMaster.ReadInputsAsync(RtuSlave.ID, startAddress, numberOfPoints);
        ...
        public ushort[] ReadWriteMultipleRegisters(ushort startReadAddress, ushort numberOfPointsToRead, ushort startWriteAddress, ushort[] writeData)
            => ModbusMaster.ReadWriteMultipleRegisters(RtuSlave.ID, startReadAddress, numberOfPointsToRead, startWriteAddress, writeData) ?? Array.Empty<ushort>();
        ...
        public async Task<ushort[]> ReadWriteMultipleRegistersAsync(ushort startReadAddress, ushort numberOfPointsToRead, ushort startWriteAddress, ushort[] writeData)
            => await ModbusMaster.ReadWriteMultipleRegistersAsync(RtuSlave.ID, startReadAddress, numberOfPointsToRead, startWriteAddress, writeData);
        ...
        public void WriteMultipleCoils(ushort startAddress, bool[] data)
            => ModbusMaster.WriteMultipleCoils(RtuSlave.ID, startAddress, data);
        ...
        public async Task WriteMultipleCoilsAsync(ushort startAddress, bool[] data)
            => await ModbusMaster.WriteMultipleCoilsAsync(RtuSlave.ID, startAddress, data);
        ...
        public void WriteMultipleRegisters(ushort startAddress, ushort[] data)
            => ModbusMaster.WriteMultipleRegisters(RtuSlave.ID, startAddress, data);
        ...
        public async Task WriteMultipleRegistersAsync(ushort startAddress, ushort[] data)
            => await ModbusMaster.WriteMultipleRegistersAsync(RtuSlave.ID, startAddress, data);
        ...
        public void WriteSingleCoil(ushort coilAddress, bool value)
            => ModbusMaster.WriteSingleCoil(RtuSlave.ID, coilAddress, value);
        ...
        public async Task WriteSingleCoilAsync(ushort coilAddress, bool value)
            => await ModbusMaster.WriteSingleCoilAsync(RtuSlave.ID, coilAddress, value);
        ...
        public void WriteSingleRegister(ushort registerAddress, ushort value)
            => ModbusMaster.WriteSingleRegister(RtuSlave.ID, registerAddress, value);
        ...
        public async Task WriteSingleRegisterAsync(ushort registerAddress, ushort value)
            => await ModbusMaster.WriteSingleRegisterAsync(RtuSlave.ID, registerAddress, value);
        ...
        public string ReadString(ushort startAddress, ushort numberOfCharacters)
            => ModbusMaster.ReadString(RtuSlave.ID, startAddress, numberOfCharacters, SwapBytes);
        ...
        public string ReadHexString(ushort startAddress, ushort numberOfHex)
            => ModbusMaster.ReadHexString(RtuSlave.ID, startAddress, numberOfHex, SwapBytes);
        ...
        public bool ReadBool(ushort startAddress)
            => ModbusMaster.ReadBool(RtuSlave.ID, startAddress);
        ...
        public BitArray ReadBits(ushort startAddress)
            => ModbusMaster.ReadBits(RtuSlave.ID, startAddress);
        ...
        public short ReadShort(ushort startAddress)
            => ModbusMaster.ReadShort(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public ushort ReadUShort(ushort startAddress)
            => ModbusMaster.ReadUShort(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public int ReadInt32(ushort startAddress)
            => ModbusMaster.ReadInt32(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public uint ReadUInt32(ushort startAddress)
            => ModbusMaster.ReadUInt32(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public float ReadFloat(ushort startAddress)
            => ModbusMaster.ReadFloat(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public double ReadDouble(ushort startAddress)
            => ModbusMaster.ReadDouble(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public long ReadLong(ushort startAddress)
            => ModbusMaster.ReadLong(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public ulong ReadULong(ushort startAddress)
            => ModbusMaster.ReadULong(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public bool[] ReadBoolArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadBoolArray(RtuSlave.ID, startAddress, length);
        ...
        public byte[] ReadBytes(ushort startAddress, ushort length)
            => ModbusMaster.ReadBytes(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public short[] ReadShortArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadShortArray(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public ushort[] ReadUShortArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadUShortArray(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public int[] ReadInt32Array(ushort startAddress, ushort length)
            => ModbusMaster.ReadInt32Array(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public uint[] ReadUInt32Array(ushort startAddress, ushort length)
            => ModbusMaster.ReadUInt32Array(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public float[] ReadFloatArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadFloatArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public double[] ReadDoubleArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadDoubleArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public long[] ReadLongArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadLongArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public ulong[] ReadULongArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadULongArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public void WriteString(ushort startAddress, string text)
             => ModbusMaster.WriteString(RtuSlave.ID, startAddress, text, SwapBytes);
        ...
        public void WriteHexString(ushort startAddress, string hex)
             => ModbusMaster.WriteHexString(RtuSlave.ID, startAddress, hex, SwapBytes);
        ...
        public void WriteBool(ushort startAddress, bool value)
            => ModbusMaster.WriteBool(RtuSlave.ID, startAddress, value);
        ...
        public void WriteBits(ushort startAddress, BitArray value)
            => ModbusMaster.WriteBits(RtuSlave.ID, startAddress, value);
        ...
        public void WriteShort(ushort startAddress, short value)
            => ModbusMaster.WriteShort(RtuSlave.ID, startAddress, value, SwapBytes);
        ...
        public void WriteUShort(ushort startAddress, ushort value)
            => ModbusMaster.WriteUShort(RtuSlave.ID, startAddress, value, SwapBytes);
        ...
        public void WriteInt32(ushort startAddress, int value)
            => ModbusMaster.WriteInt32(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteUInt32(ushort startAddress, uint value)
            => ModbusMaster.WriteUInt32(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteFloat(ushort startAddress, float value)
            => ModbusMaster.WriteFloat(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteDouble(ushort startAddress, double value)
            => ModbusMaster.WriteDouble(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteLong(ushort startAddress, long value)
            => ModbusMaster.WriteLong(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteULong(ushort startAddress, ulong value)
            => ModbusMaster.WriteULong(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public void WriteBoolArray(ushort startAddress, bool[] values)
            => ModbusMaster.WriteBoolArray(RtuSlave.ID, startAddress, values);
        ...
        public void WriteBytes(ushort startAddress, byte[] values)
            => ModbusMaster.WriteBytes(RtuSlave.ID, startAddress, values);
        ...
        public void WriteShortArray(ushort startAddress, short[] values)
            => ModbusMaster.WriteShortArray(RtuSlave.ID, startAddress, values, SwapBytes);
        ...
        public void WriteUShortArray(ushort startAddress, ushort[] values)
            => ModbusMaster.WriteUShortArray(RtuSlave.ID, startAddress, values, SwapBytes);
        ...
        public void WriteInt32Array(ushort startAddress, int[] values)
            => ModbusMaster.WriteInt32Array(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public void WriteUInt32Array(ushort startAddress, uint[] values)
            => ModbusMaster.WriteUInt32Array(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public void WriteFloatArray(ushort startAddress, float[] values)
            => ModbusMaster.WriteFloatArray(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public void WriteDoubleArray(ushort startAddress, double[] values)
            => ModbusMaster.WriteDoubleArray(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public void WriteLongArray(ushort startAddress, long[] values)
            => ModbusMaster.WriteLongArray(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public void WriteULongArray(ushort startAddress, ulong[] values)
            => ModbusMaster.WriteULongArray(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public string ReadOnlyString(ushort startAddress, ushort numberOfCharacters)
            => ModbusMaster.ReadOnlyString(RtuSlave.ID, startAddress, numberOfCharacters, SwapBytes);
        ...
        public string ReadOnlyHexString(ushort startAddress, ushort numberOfHex)
            => ModbusMaster.ReadOnlyHexString(RtuSlave.ID, startAddress, numberOfHex, SwapBytes);
        ...
        public bool ReadOnlyBool(ushort startAddress)
            => ModbusMaster.ReadOnlyBool(RtuSlave.ID, startAddress);
        ...
        public BitArray ReadOnlyBits(ushort startAddress)
            => ModbusMaster.ReadOnlyBits(RtuSlave.ID, startAddress);
        ...
        public short ReadOnlyShort(ushort startAddress)
            => ModbusMaster.ReadOnlyShort(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public ushort ReadOnlyUShort(ushort startAddress)
            => ModbusMaster.ReadOnlyUShort(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public int ReadOnlyInt32(ushort startAddress)
            => ModbusMaster.ReadOnlyInt32(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public uint ReadOnlyUInt32(ushort startAddress)
            => ModbusMaster.ReadOnlyUInt32(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public float ReadOnlyFloat(ushort startAddress)
            => ModbusMaster.ReadOnlyFloat(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public double ReadOnlyDouble(ushort startAddress)
            => ModbusMaster.ReadOnlyDouble(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public long ReadOnlyLong(ushort startAddress)
            => ModbusMaster.ReadOnlyLong(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public ulong ReadOnlyULong(ushort startAddress)
            => ModbusMaster.ReadOnlyULong(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public bool[] ReadOnlyBoolArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyBoolArray(RtuSlave.ID, startAddress, length);
        ...
        public byte[] ReadOnlyBytes(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyBytes(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public short[] ReadOnlyShortArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyShortArray(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public ushort[] ReadOnlyUShortArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyUShortArray(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public int[] ReadOnlyInt32Array(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyInt32Array(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public uint[] ReadOnlyUInt32Array(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyUInt32Array(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public float[] ReadOnlyFloatArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyFloatArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public double[] ReadOnlyDoubleArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyDoubleArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public long[] ReadOnlyLongArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyLongArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public ulong[] ReadOnlyULongArray(ushort startAddress, ushort length)
            => ModbusMaster.ReadOnlyULongArray(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<string> ReadStringAsync(ushort startAddress, ushort numberOfCharacters)
            => await ModbusMaster.ReadStringAsync(RtuSlave.ID, startAddress, numberOfCharacters, SwapBytes);
        ...
        public async Task<string> ReadHexStringAsync(ushort startAddress, ushort numberOfHex)
            => await ModbusMaster.ReadHexStringAsync(RtuSlave.ID, startAddress, numberOfHex, SwapBytes);
        ...
        public async Task<bool> ReadBoolAsync(ushort startAddress)
            => await ModbusMaster.ReadBoolAsync(RtuSlave.ID, startAddress);
        ...
        public async Task<BitArray> ReadBitsAsync(ushort startAddress)
            => await ModbusMaster.ReadBitsAsync(RtuSlave.ID, startAddress);
        ...
        public async Task<short> ReadShortAsync(ushort startAddress)
            => await ModbusMaster.ReadShortAsync(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public async Task<ushort> ReadUShortAsync(ushort startAddress)
            => await ModbusMaster.ReadUShortAsync(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public async Task<Int32> ReadInt32Async(ushort startAddress)
            => await ModbusMaster.ReadInt32Async(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<uint> ReadUInt32Async(ushort startAddress)
            => await ModbusMaster.ReadUInt32Async(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<float> ReadFloatAsync(ushort startAddress)
            => await ModbusMaster.ReadFloatAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<double> ReadDoubleAsync(ushort startAddress)
            => await ModbusMaster.ReadDoubleAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<long> ReadLongAsync(ushort startAddress)
            => await ModbusMaster.ReadLongAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<ulong> ReadULongAsync(ushort startAddress)
            => await ModbusMaster.ReadULongAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<bool[]> ReadBoolArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadBoolArrayAsync(RtuSlave.ID, startAddress, length);
        ...
        public async Task<byte[]> ReadBytesAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadBytesAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<short[]> ReadShortArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadShortArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<ushort[]> ReadUShortArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadUShortArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<Int32[]> ReadInt32ArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadInt32ArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<UInt32[]> ReadUInt32ArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadUInt32ArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<float[]> ReadFloatArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadFloatArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<double[]> ReadDoubleArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadDoubleArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<long[]> ReadLongArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadLongArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<ulong[]> ReadULongArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadULongArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task WriteStringAsync(ushort startAddress, string text)
            => await ModbusMaster.WriteStringAsync(RtuSlave.ID, startAddress, text, SwapBytes);
        ...
        public async Task WriteHexStringAsync(ushort startAddress, string hex)
            => await ModbusMaster.WriteHexStringAsync(RtuSlave.ID, startAddress, hex, SwapBytes);
        ...
        public async Task WriteBoolAsync(ushort startAddress, bool value)
            => await ModbusMaster.WriteBoolAsync(RtuSlave.ID, startAddress, value);
        ...
        public async Task WriteBitsAsync(ushort startAddress, BitArray value)
            => await ModbusMaster.WriteBitsAsync(RtuSlave.ID, startAddress, value);
        ...
        public async Task WriteShortAsync(ushort startAddress, short value)
            => await ModbusMaster.WriteShortAsync(RtuSlave.ID, startAddress, value, SwapBytes);
        ...
        public async Task WriteUShortAsync(ushort startAddress, ushort value)
            => await ModbusMaster.WriteUShortAsync(RtuSlave.ID, startAddress, value, SwapBytes);
        ...
        public async Task WriteInt32Async(ushort startAddress, int value)
            => await ModbusMaster.WriteInt32Async(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteUInt32Async(ushort startAddress, uint value)
            => await ModbusMaster.WriteUInt32Async(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteFloatAsync(ushort startAddress, float value)
            => await ModbusMaster.WriteFloatAsync(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteDoubleAsync(ushort startAddress, double value)
            => await ModbusMaster.WriteDoubleAsync(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteLongAsync(ushort startAddress, long value)
            => await ModbusMaster.WriteLongAsync(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteULongAsync(ushort startAddress, ulong value)
            => await ModbusMaster.WriteULongAsync(RtuSlave.ID, startAddress, value, SwapBytes, SwapWords);
        ...
        public async Task WriteBoolArrayAsync(ushort startAddress, bool[] values)
            => await ModbusMaster.WriteBoolArrayAsync(RtuSlave.ID, startAddress, values);
        ...
        public async Task WriteBytesAsync(ushort startAddress, byte[] values)
            => await ModbusMaster.WriteBytesAsync(RtuSlave.ID, startAddress, values);
        ...
        public async Task WriteShortArrayAsync(ushort startAddress, short[] values)
            => await ModbusMaster.WriteShortArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes);
        ...
        public async Task WriteUShortArrayAsync(ushort startAddress, ushort[] values)
            => await ModbusMaster.WriteUShortArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes);
        ...
        public async Task WriteInt32ArrayAsync(ushort startAddress, Int32[] values)
            => await ModbusMaster.WriteInt32ArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task WriteUInt32ArrayAsync(ushort startAddress, UInt32[] values)
            => await ModbusMaster.WriteUInt32ArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task WriteFloatArrayAsync(ushort startAddress, float[] values)
            => await ModbusMaster.WriteFloatArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task WriteDoubleArrayAsync(ushort startAddress, double[] values)
            => await ModbusMaster.WriteDoubleArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task WriteLongArrayAsync(ushort startAddress, long[] values)
            => await ModbusMaster.WriteLongArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task WriteULongArrayAsync(ushort startAddress, ulong[] values)
            => await ModbusMaster.WriteULongArrayAsync(RtuSlave.ID, startAddress, values, SwapBytes, SwapWords);
        ...
        public async Task<string> ReadOnlyStringAsync(ushort startAddress, ushort numberOfCharacters)
            => await ModbusMaster.ReadOnlyStringAsync(RtuSlave.ID, startAddress, numberOfCharacters, SwapBytes);
        ...
        public async Task<string> ReadOnlyHexStringAsync(ushort startAddress, ushort numberOfHex)
            => await ModbusMaster.ReadOnlyHexStringAsync(RtuSlave.ID, startAddress, numberOfHex, SwapBytes);
        ...
        public async Task<bool> ReadOnlyBoolAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyBoolAsync(RtuSlave.ID, startAddress);
        ...
        public async Task<BitArray> ReadOnlyBitsAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyBitsAsync(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public async Task<short> ReadOnlyShortAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyShortAsync(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public async Task<ushort> ReadOnlyUShortAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyUShortAsync(RtuSlave.ID, startAddress, SwapBytes);
        ...
        public async Task<Int32> ReadOnlyInt32Async(ushort startAddress)
            => await ModbusMaster.ReadOnlyInt32Async(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<uint> ReadOnlyUInt32Async(ushort startAddress)
            => await ModbusMaster.ReadOnlyUInt32Async(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<float> ReadOnlyFloatAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyFloatAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<double> ReadOnlyDoubleAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyDoubleAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<long> ReadOnlyLongAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyLongAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<ulong> ReadOnlyULongAsync(ushort startAddress)
            => await ModbusMaster.ReadOnlyULongAsync(RtuSlave.ID, startAddress, SwapBytes, SwapWords);
        ...
        public async Task<bool[]> ReadOnlyBoolArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyBoolArrayAsync(RtuSlave.ID, startAddress, length);
        ...
        public async Task<byte[]> ReadOnlyBytesAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyBytesAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<short[]> ReadOnlyShortArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyShortArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<ushort[]> ReadOnlyUShortArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyUShortArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes);
        ...
        public async Task<Int32[]> ReadOnlyInt32ArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyInt32ArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<UInt32[]> ReadOnlyUInt32ArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyUInt32ArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<float[]> ReadOnlyFloatArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyFloatArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<double[]> ReadOnlyDoubleArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyDoubleArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<long[]> ReadOnlyLongArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyLongArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
        ...
        public async Task<ulong[]> ReadOnlyULongArrayAsync(ushort startAddress, ushort length)
            => await ModbusMaster.ReadOnlyULongArrayAsync(RtuSlave.ID, startAddress, length, SwapBytes, SwapWords);
