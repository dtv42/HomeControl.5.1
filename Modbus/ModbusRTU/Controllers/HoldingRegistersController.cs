...
// </license>
// <created>21-4-2020 21:06</created>
...
namespace ModbusRTU.Controllers
{
    ...
    public class HoldingRegistersController : ModbusController
    {
        ...
        public HoldingRegistersController(IRtuModbusClient client,
        ...
        public async Task<IActionResult> ReadHoldingRegistersAsync(ushort offset = 0, ushort number = 1, byte? slave = null)
        {
            ...
            return await ModbusReadRequest(request, ReadRequestFunctions.ReadHoldingRegistersAsync);
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteHoldingRegistersAsync([FromBody, Required] List<ushort> data, ushort offset = 0, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData()
            {
                Offset = offset,
            ...
            return await ModbusWriteArrayRequest(request, data.ToArray(), WriteArrayRequestFunctions.WriteHoldingRegistersAsync);
        }
    }
}
