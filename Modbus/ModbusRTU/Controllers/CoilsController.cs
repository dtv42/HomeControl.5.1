...
namespace ModbusRTU.Controllers
{
    ...
    public class CoilsController : ModbusController
    {
        ...
        public CoilsController(IRtuModbusClient client,
        ...
        public async Task<IActionResult> ReadCoilsAsync(ushort offset = 0, ushort number = 1, byte? slave = null)
        {
            ...
            return await ModbusReadRequest(request, ReadRequestFunctions.ReadCoilsAsync);
        }
        ...
        [ProducesResponseType(typeof(string), 500)]
        [ProducesResponseType(typeof(string), 502)]
        public async Task<IActionResult> WriteCoilsAsync([FromBody, Required] List<bool> data, ushort offset = 0, byte? slave = null)
        {
            ModbusRequestData request = new ModbusRequestData()
            {
                Offset = offset,
            ...
            return await ModbusWriteArrayRequest(request, data.ToArray(), WriteArrayRequestFunctions.WriteCoilsAsync);
        }
    }
}
