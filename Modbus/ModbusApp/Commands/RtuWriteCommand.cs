...
namespace ModbusApp.Commands
{
    ...
    [Command(Name = "write",
             FullName = "ModbusApp RTU Write Command",
             Description = "Supporting Modbus RTU write operations.",
             ExtendedHelpText = "\nPlease specify the write option (coils or holding registers).")]
    public class RtuWriteCommand : BaseCommand<RtuWriteCommand, AppSettings>
    {
        ...
        public RtuWriteCommand(IRtuModbusClient client,
                               ...
                               ILogger<RtuWriteCommand> logger,
        ...
        public int OnExecute()
        {
            ...
            {
                _logger.LogError("RtuWriteCommand exception");
                throw;
            }
            finally
            {
